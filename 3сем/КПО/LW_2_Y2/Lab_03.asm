...
STR1	DB	"Вторая программа на ассемблере",	0									; строка, первый элемент данные + нулевой бит
...
START	:													; метка
	   ...
	   mov STR2 + 21, al ; строка + позиция, регистр со значением
