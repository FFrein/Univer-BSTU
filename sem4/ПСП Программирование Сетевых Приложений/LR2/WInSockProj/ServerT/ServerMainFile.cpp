...
int main()
{
    ...
    WSADATA wsaData;                                                              // структура, содержит сведения о реализации сокетов Windows
    ...
    try {
        ...
        if (bind(sS, (LPSOCKADDR)&serv, sizeof(serv)) == SOCKET_ERROR) {
            throw  SetErrorMsgText("bind: ", WSAGetLastError());
                                                                                 ...
                                                                                 // перевод сокета в состояние прослушивания, открывает доступ к нему (связанный сокет, максимальная длина очереди)
