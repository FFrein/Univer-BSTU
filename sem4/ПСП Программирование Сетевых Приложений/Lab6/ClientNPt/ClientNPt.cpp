	...
	try
	{
			...
			NULL)) == INVALID_HANDLE_VALUE)																																// доп флаги
		{
			throw SetPipeError("CreateFile: ", GetLastError());
																																										...
																																										// -- изменить характеристики канал
		if (!SetNamedPipeHandleState(
									cH,																																	// [in] дескриптор именованного канала
									&state,																																// [in] указатель на новое состояние канала
									NULL,																																// [in] указатель на макс. к-во байтов 
									NULL																																// [in] указатель на интервал задержки
									)
			)																																							// функция предназначена для изменения динамических характеристик именованного канала
		{
